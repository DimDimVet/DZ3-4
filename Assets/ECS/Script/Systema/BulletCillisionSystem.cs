...
public class BulletCillisionSystem : ComponentSystem
{
    ...
    protected override void OnCreate()
    {
        ...
        entityQuery = GetEntityQuery(ComponentType.ReadOnly<ColliderData2>(),
    ...
    protected override void OnUpdate()
    {
        ...
        Entities.With(entityQuery).ForEach
            (
            (Entity entity, BulletCollisionComponent collisions, ref ColliderData2 colliderData) =>
            {
                if (collisions != null)
                {
                    ...
                    if (size > 0)//если результат Physics.Overlap более 0
                    {
                        ...
                        collisions.ExecuteBullet(colliders);
                    }
                }
